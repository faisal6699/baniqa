              ...
              <div className="container">
                <div className="row">
                  <div className="col-xl-3 col-md-4">
                    <Link to={'/page'}>
                      <div className="img">
                        <img className="rounded" src={img10} alt="new-seller" />
                      </div>
                    </Link>
                  </div>
                  <div className="col-xl-3 col-md-4">
                    <Link to={'/page'}>
                      <div className="img">
                        <img className="rounded" src={img11} alt="new-seller" />
                      </div>
                    </Link>
                  </div>
                  <div className="col-xl-3 col-md-4">
                    <Link to={'/page'}>
                      <div className="img">
                        <img className="rounded" src={img12} alt="new-seller" />
                      </div>
                    </Link>
                  </div>
                  <div className="col-xl-3 col-md-4">
                    <Link to={'/page'}>
                      <div className="img">
                        <img className="rounded" src={img13} alt="new-seller" />
                      </div>
                    </Link>
                  </div>
                </div>
