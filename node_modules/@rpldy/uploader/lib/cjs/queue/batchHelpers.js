...
exports.ensureNonUploadingBatchCleaned = exports.removePendingBatches = exports.preparePendingForUpload = exports.detachRecycledFromPreviousBatch = exports.getBatchFromState = exports.getIsItemBatchReady = exports.triggerUploaderBatchEvent = exports.cleanUpFinishedBatch = exports.getBatchDataFromItemId = exports.isItemBelongsToBatch = exports.getBatchFromItemId = exports.cancelBatchForItem = exports.isNewBatchStarting = exports.loadNewBatchForItem = exports.isBatchFinished = void 0;
...
var ensureNonUploadingBatchCleaned = function (queue, batchId) {
  ...
  var activeItem = batch.items.find(function (item) {
    return !_consts.ITEM_FINALIZE_STATES.includes(item.state);
...
exports.ensureNonUploadingBatchCleaned = ensureNonUploadingBatchCleaned;